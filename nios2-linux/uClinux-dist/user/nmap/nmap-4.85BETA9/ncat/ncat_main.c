/* $Id: ncat_main.c 13231 2009-05-09 03:24:52Z david $ */
...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        case 'h':
            ...
            printf("      --send-only            Only send data, ignoring received; quit on EOF\n");
            ...
            printf("      --chat                 Use with --broker to chat with other connected users\n");
            ...
            printf("      --ssl-verify           Verify trust and domain name of certificates\n");
            printf("      --ssl-trustfile        PEM file containing trusted SSL certificates\n");
#endif
