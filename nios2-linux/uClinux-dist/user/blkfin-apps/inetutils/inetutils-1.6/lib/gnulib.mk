...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libgnu --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --no-libtool --macro-prefix=gl alloca alloca-opt argp autobuild dirfd error exit exitfail extensions filemode free getcwd getline getopt getpass gettext gettext-h getusershell glob inttostr malloc memcmp memcpy memmove mempcpy memset minmax obstack poll progname readline readutmp realloc regex setenv size_max snprintf stdbool stdint strcase strchrnul strdup strerror strndup strnlen sysexits unistd-safer unlocked-io vasnprintf version-etc-fsf vsnprintf xalloc xalloc-die xgetcwd xgetdomainname xgethostname xsize
...
EXTRA_libgnu_a_SOURCES += memset.c
