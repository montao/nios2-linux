...
Currently available applets include:
	...
	[, [[, awk, base64, basename, blockdev, bootchartd, bunzip2, bzcat,
	cat, chgrp, chmod, chown, chroot, clear, cmp, cp, cpio, cut, date,
	dd, df, diff, dmesg, dnsdomainname, du, echo, env, expr, false,
	fgconsole, find, flock, free, ftpget, ftpput, getopt, getty, grep,
	gunzip, gzip, head, hexdump, hostname, hush, hwclock, id, ifconfig,
	insmod, iostat, kill, killall, last, ln, logname, losetup, ls,
	lsmod, md5sum, mkdir, mkfifo, mknod, modinfo, modprobe, more, mount,
	mpstat, mv, nbd-client, nc, netstat, nslookup, passwd, pidof, ping,
	pmap, powertop, printf, ps, pwd, readlink, renice, rev, rm, rmdir,
	rmmod, route, sed, seq, sh, sleep, smemcap, sort, stty, sync, tail,
	tar, tee, test, tftp, time, top, touch, tr, traceroute, true, tty,
	umount, uname, uniq, unxz, uptime, usleep, vconfig, vi, watch, wc,
...
grep [-HhnlLoqvsriwF] [-m N] PATTERN/-e PATTERN.../-f FILE [FILE]...
...
tar -[cxtmvO] [-X FILE] [-f TARFILE] [-C DIR] [FILE]...
