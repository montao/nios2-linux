...
{
  return (0 ? 0
  : ((code >= 0) && (code <= 180)) ? (code - 0)
  : ((code >= 199) && (code <= 213)) ? (code - 18)
  : ((code >= 257) && (code <= 271)) ? (code - 61)
  : ((code >= 273) && (code <= 281)) ? (code - 62)
  : ((code >= 1024) && (code <= 1039)) ? (code - 804)
  : ((code >= 16381) && (code <= 16383)) ? (code - 16145)
  : 16384 - 16145);
}
