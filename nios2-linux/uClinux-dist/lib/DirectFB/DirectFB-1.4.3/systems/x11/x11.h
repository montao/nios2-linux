...
DFBResult dfb_x11_create_window_handler ( DFBX11 *x11, SetModeData *setmode ) D_HIDDEN;
DFBResult dfb_x11_destroy_window_handler( DFBX11 *x11, DestroyData *destroy ) D_HIDDEN;
