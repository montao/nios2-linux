...
# build directory.
ITK_BUILD_LIB_SPEC='-L/home/dwesterg/data/nios2-linux/nios2-linux/insight/itcl/itk -litk3.2${TCL_DBGX}'
...
# build directory.
ITK_BUILD_STUB_LIB_SPEC='-L/home/dwesterg/data/nios2-linux/nios2-linux/insight/itcl/itk -litkstub3.2${TCL_DBGX}'
...
ITK_SRC_DIR='/home/dwesterg/data/nios2-linux/nios2-linux/insight/itcl/itk'
