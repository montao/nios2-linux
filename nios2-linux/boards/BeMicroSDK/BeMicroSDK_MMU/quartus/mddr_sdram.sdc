...
#MK:  Not needed, handled by set_clock_groups in BeMicro_MK.sdc
#MK:set system_clk       {inst1|altpll_component|auto_generated|pll1|clk[0]}
...
#MK:  Not needed, handled by set_clock_groups in BeMicro_MK.sdc
#MK:set_false_path -from [get_clocks $system_clk] -to [get_clocks $sdram_clk]
#MK:set_false_path -from [get_clocks $sdram_clk] -to  [get_clocks $system_clk]

#MK:  Not needed, handled by set_clock_groups in BeMicro_MK.sdc
#MK:set_false_path -from [get_clocks $system_clk] -to [get_clocks $sdram_write_clk]
#MK:set_false_path -from [get_clocks $sdram_write_clk] -to  [get_clocks $system_clk]
...
#MK:  Not needed, handled by set_clock_groups in BeMicro_MK.sdc
#MK:    set_false_path -from [get_clocks ${dqspin}_out] -to [get_clocks $system_clk]
#MK:    set_false_path -from [get_clocks $system_clk]   -to [get_clocks ${dqspin}_out]
...
#MK:  Not needed, handled by set_clock_groups in BeMicro_MK.sdc
#MK:    set_false_path -from [get_clocks ${dqspin}_in] -to [get_clocks $system_clk]
#MK:    set_false_path -from [get_clocks $system_clk]  -to [get_clocks ${dqspin}_in]
...
#MK:  the following line was erroring out:
#MK:     set_clock_groups -exclusive -group [get_clocks {*msdram_dqs[*]_in}] -group [get_clocks {*msdram_dqs[*]_out}]
#MK:  replaced it with the following:
...
#MK: Commenting out ignored constraints
#MK: set_false_path -from [get_keepers {*|mtx_sdram_controller:*|sdram_suppress_first_write*}] -to [get_keepers {*|mtx_sdram_controller:*|lsp_sdram_suppress_first_write*}]
...
#MK:  According to support@micrtonix.com the following
#MK:  false paths are safe
set synch_data_out "nios2_bemicro_sopc:nios2_bemicro_sopc_inst|nios2_bemicro_sopc_reset_pll_c0_out_domain_synch_module:nios2_bemicro_sopc_reset_pll_c0_out_domain_synch|data_out"

set_false_path -from [get_keepers $synch_data_out] \
               -through [get_pins -compatibility_mode "*|clrn *|areset"] \
               -to [get_keepers "*mobile_ddr_sdram* *mobile_ddr_sdram*ddio_outa[0]~DFFHI *mobile_ddr_sdram*ddio_outa[0]~DFFLO"]
...
#MK:============================================================================
#MK:  Multicycle constraints
#MK:============================================================================


#MK:-----------------------------------
#MK:  Clean up Setup/Hold Violations
#MK:-----------------------------------
# src:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]
# dst:     the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[0]
# type:    setup
# edge:    end
# amount:  2
set_multicycle_path -setup -end 2 \
	-from [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]] \
	-to [get_clocks the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[0]] 
...
# src:     the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[0]
# dst:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]
# type:    setup
# edge:    end
# amount:  2
set_multicycle_path -setup -end 2 \
	-from [get_clocks the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[0]] \
	-to [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]] 
...
#MK:-----------------------------------
#MK:  Clean up Rec/Rem Violations
#MK:-----------------------------------

# src:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]
# dst:     the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[1]
# type:    setup
# edge:    end
# amount:  2
set_multicycle_path -setup -end 2 \
	-from [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]] \
	-to [get_clocks the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[1]] 
...
# src:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]
# dst:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[1]
# type:    setup
# edge:    end
# amount:  2
set_multicycle_path -setup -end 2 \
   -through [get_pins -compatibility_mode {*|clrn *|clr1}] \
	-from [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]] \
	-to [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[1]] 
...
# src:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[1]
# dst:     nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]
# type:    setup
# edge:    end
# amount:  2
set_multicycle_path -setup -end 2 \
   -through [get_pins -compatibility_mode {*|clrn *|clr1}] \
	-from [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[1]] \
	-to [get_clocks nios2_bemicro_sopc_inst|the_pll|sd1|pll7|clk[0]] 
...
#MK:============================================================================
#MK:  Not OK'ed by Microtronix
#MK:============================================================================
#MK: # src:     the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[1]
#MK: # dst:     RAM_LDQS_out
#MK: # type:    setup
#MK: # edge:    end
#MK: # amount:  2
#MK: set_multicycle_path -setup -end 2 \
#MK: 	-from [get_clocks the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[1]] \
#MK: 	-to [get_clocks RAM_LDQS_out] 
...
#MK: # edge:    end
#MK: # amount:  1
#MK: set_multicycle_path -hold -end 1 \
#MK: 	-from [get_clocks the_M_DDR_PLL_inst|altpll_component|auto_generated|pll1|clk[1]] \
#MK: 	-to [get_clocks RAM_LDQS_out] 
